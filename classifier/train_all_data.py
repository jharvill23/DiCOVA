...
class Solver(object):
    ...
    def get_train_test(self):
        ...
        train_files = {'positive': partition['train_pos'] + partition['val_pos'],
                       'negative': partition['train_neg'] + partition['val_neg']}
        # test_files = {'positive': partition['test_positive'], 'negative': partition['test_negative']}
        val_files = {'positive': partition['train_pos'] + partition['val_pos'],
                     'negative': partition['train_neg'] + partition['val_neg']}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--TRIAL', type=str, default='dumdumalldata')
