...
def main(args):
    ...
    """All data models"""
    # best_models = {'1': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/164500-G.ckpt',
    #                      './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/168000-G.ckpt'],
    #                '2': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/153500-G.ckpt',
    #                      './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/161500-G.ckpt'],
    #                '3': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/143500-G.ckpt',
    #                      './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/152500-G.ckpt'],
    #                '4': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/122500-G.ckpt',
    #                      './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/144000-G.ckpt'],
    #                '5': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/138000-G.ckpt',
    #                      './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/123000-G.ckpt']}
    # """All data models not maxed out on validation approx 94 validation"""
    # best_models = {
    #     '1': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/62000-G.ckpt',
    #           './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/51000-G.ckpt'],
    #     '2': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/62000-G.ckpt',
    #           './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/51000-G.ckpt'],
    #     '3': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/62000-G.ckpt',
    #           './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/51000-G.ckpt'],
    #     '4': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/62000-G.ckpt',
    #           './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/51000-G.ckpt'],
    #     '5': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/62000-G.ckpt',
    #           './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/51000-G.ckpt']}
    # """All data models not maxed out on validation approx 90 validation"""
    # best_models = {
    #     '1': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/44000-G.ckpt',
    #           './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/38000-G.ckpt'],
    #     '2': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/44000-G.ckpt',
    #           './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/38000-G.ckpt'],
    #     '3': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/44000-G.ckpt',
    #           './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/38000-G.ckpt'],
    #     '4': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/44000-G.ckpt',
    #           './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/38000-G.ckpt'],
    #     '5': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/44000-G.ckpt',
    #           './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/38000-G.ckpt']}

    """All data models not maxed out on validation approx 94-100 validation ensemble"""
    best_models = {
        '1': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/70000-G.ckpt',
              './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/55500-G.ckpt'],
        '2': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/78500-G.ckpt',
              './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/62500-G.ckpt'],
        '3': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/86500-G.ckpt',
              './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/70000-G.ckpt'],
        '4': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/109500-G.ckpt',
              './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/90000-G.ckpt'],
        '5': ['./exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try1/models/123000-G.ckpt',
              './exps/tryna_win_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_try2/models/106000-G.ckpt']}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--TRIAL', type=str, default='Evaluations_scaling_10_ff_pretraining_coughvid_specaug_prob_1dot0_ensemble_ALL_DATA_not_maxed_val_try3_val94-100')
